...
def Encode(string, encoding=...): # -> binary_type | None:
...
def GetEncodedValue(env, name, default=...): # -> text_type | None:
...
def EncodeEnv(env, encoding=...): # -> dict[Unknown | binary_type | None, Unknown | binary_type | None]:
