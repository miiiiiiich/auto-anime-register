...
class ConsoleAttr:
  ...
  def Colorize(self, string, color, justify=...): # -> str:
  ...
  def GetBoxLineCharacters(self): # -> BoxLineCharactersUnicode | BoxLineCharactersAscii | BoxLineCharactersScreenReader:
  ...
  def GetBullets(self): # -> tuple[Literal['▪'], Literal['◆'], Literal['▸'], Literal['▫'], Literal['◇'], Literal['▹']] | tuple[Literal['■'], Literal['≡'], Literal['∞'], Literal['Φ'], Literal['·']] | tuple[Literal['o'], Literal['*'], Literal['+'], Literal['-']]:
  ...
  def GetProgressTrackerSymbols(self): # -> ProgressTrackerSymbolsUnicode | ProgressTrackerSymbolsAscii:
  ...
  def GetControlSequenceIndicator(self): # -> str | None:
  ...
  def GetControlSequenceLen(self, buf): # -> int:
  ...
  def GetFontCode(self, bold=..., italic=...): # -> str:
  ...
  def GetTermIdentifier(self): # -> str:
  ...
  def GetTermSize(self): # -> tuple[Literal[0], Literal[0]] | tuple[Any, Any] | tuple[Literal[80], Literal[24]]:
  ...
  def SplitIntoNormalAndControl(self, buf): # -> list[tuple[Unknown, Literal['']]] | list[Unknown]:
  ...
  def SplitLine(self, line, width): # -> list[Unknown]:
...
def GetConsoleAttr(encoding=..., reset=...): # -> ConsoleAttr | None:
...
def ResetConsoleAttr(encoding=...): # -> ConsoleAttr | None:
...
def GetCharacterDisplayWidth(char): # -> Literal[1, 0, 2]:
...
def SafeText(data, encoding=..., escape=...): # -> text_type | None:
...
def Decode(data, encoding=...): # -> text_type | None:
